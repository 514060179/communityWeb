...
(function (vc) {
    ...
    vc.extends({
        ...
        methods: {
                ...
                vc.http.apiGet('/maintainance.listMaintainanceStandard',
                    ...
                    function (json, res) {
                        ...
                        vc.emit('pagination', 'init', {
                            ...
                            dataCount: vc.component.maintainanceStandardManageInfo.total,
                            currentPage: _page
                        });
            ...
            _resetMaintainanceStandardMethod: function () {
                vc.component.maintainanceStandardManageInfo.conditions.standardName = "";
                vc.component._listMaintainanceStandards(DEFAULT_PAGE, DEFAULT_ROWS);
            },
