    ...
    vc.extends({
        ...
        methods: {
            ...
            _toDetail: function (_item) {
                vc.jumpToPage("/#/pages/common/allocationStorehouseDetail?applyId=" +
                    _item.applyId + '&applyType=' + _item.applyType + '&applyTypeName=' + _item.applyTypeName);
            },
            ...
            _exportExcel: function () {
                /*vc.jumpToPage('/callComponent/exportReportFee/exportData?pagePath=allocationStorehouse&'
                    + vc.objToGetParam($that.allocationStorehouseManageInfo.conditions));*/
                vc.component.allocationStorehouseManageInfo.conditions.communityId = vc.getCurrentCommunity().communityId;
                vc.component.allocationStorehouseManageInfo.conditions.pagePath = 'allocationStorehouseManage';
                let param = {
