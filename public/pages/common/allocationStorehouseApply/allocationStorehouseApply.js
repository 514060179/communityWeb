...
(function (vc) {
    ...
    vc.extends({
        ...
        methods: {
            _reset: function(){
                $that.allocationStorehouseApplyInfo = {
                    resourceStores: [],
                    total: 0,
                    records: 1,
                    moreCondition: false,
            ...
            _openAllocationStorehouseModel: function () {
                let _shId = $that.allocationStorehouseApplyInfo.shId;
                let remark = $that.allocationStorehouseApplyInfo.remark;
                if (!_shId) {
                    vc.toast('请选择仓库！');
                    return;
                }
            ...
            _computeFlow: function () {
                // 仓库一改变，就清空已选择的商品信息
                $that.allocationStorehouseApplyInfo.resourceStores = [];
