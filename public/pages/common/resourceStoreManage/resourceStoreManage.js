    ...
    vc.extends({
        ...
        methods: {
            ...
            _jump2InPage: function () {
                vc.jumpToPage("/#/pages/common/addPurchaseApply?resOrderType=10000&purchaseSwitch=OFF");
            },
            // 跳转出入库页面
            _jump2OutPage: function () {
                vc.jumpToPage("/#/pages/common/addItemOut?resOrderType=20000&from=resourceStore");
            },
            ...
            _exportExcel: function () {
                ...
                vc.component.resourceStoreManageInfo.conditions.pagePath = 'resourceStoreManage';
                let param = {
