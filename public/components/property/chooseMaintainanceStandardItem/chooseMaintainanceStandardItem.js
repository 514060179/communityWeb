(function (vc) {
    ...
    vc.extends({
        ...
        methods: {
            _loadAllItemsInfo: function (_page, _row) {
                let param = {
                    params: {
                        page: _page,
                        row: _row,
                        itemTitle: vc.component.chooseMaintainanceStandardItemInfo.itemTitle,
            ...
            //重置
            resetItems: function () {
                $that.chooseMaintainanceStandardItemInfo.itemTitle = "";
                $that._loadAllItemsInfo(1, 10);
            },
