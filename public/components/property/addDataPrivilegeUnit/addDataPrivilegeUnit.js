(function (vc) {
    ...
    vc.extends({
        ...
        methods: {
            _loadAllUnitsInfo: function (_page, _row) {
                let param = {
                    params: {
                        page: _page,
                        row: _row,
            ...
            //查询
            queryUnits: function () {
                $that._loadAllUnitsInfo(DEFAULT_PAGE, DEFAULT_ROWS);
            },
            //重置
            _resetUnits: function () {
                vc.component.addDataPrivilegeUnitInfo.floorNum = "";
                vc.component.addDataPrivilegeUnitInfo.unitNum = "";
                $that._loadAllUnitsInfo(DEFAULT_PAGE, DEFAULT_ROWS);
            },
