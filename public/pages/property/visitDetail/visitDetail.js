    ...
    vc.extends({
        ...
        methods: {
            ...
            _auditSubmit: function () {
                 ...
                 *
                 */
                if ($that.visitDetailInfo.nextAudit.assignee != '-2' && $that.visitDetailInfo.nextAudit.assignee != '-1') {
                ...
                if (_audit.auditCode != '1100' && _audit.auditCode != '1200' && _audit.auditCode != '1400' && !_audit.staffId) {
                    vc.toast('请选择下一节点处理人');
                    return;
                }
                vc.http.apiPost(
            ...
            _changeAuditCode: function(){
                $that.visitDetailInfo.audit.staffId = '';
                $that.visitDetailInfo.audit.staffName = '';
            }
        }
    });
})(window.vc);