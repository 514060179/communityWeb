        ...
        _initEvent: function () {
            ...
            vc.on('carDetailCouponOrder', 'paginationPlus', 'page_event',
                function (_currentPage) {
                    $that._loadCarDetailCouponOrderData(_currentPage, DEFAULT_ROWS);
                });
        },
        methods: {
            _loadCarDetailCouponOrderData: function (_page, _row) {
                let param = {
                    params: {
                        ...
                        iotApiCode: 'listParkingCouponCarOrderBmoImpl',
                        page: _page,
                        row: _row
                    }
                };
                ...
                vc.http.apiGet('/iot.getOpenApi',
                    ...
                    function (json) {
                        ...
                        $that.carDetailCouponOrderInfo.orders = _roomInfo.data;
