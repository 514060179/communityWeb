...
(function (vc) {
    ...
    vc.extends({
        ...
        methods: {
            ...
            _resetCopyWorkMethod: function () {
                vc.component.copyWorkInfo.conditions.workName = "";
                vc.component.copyWorkInfo.conditions.createUserNameLike = "";
                vc.component.copyWorkInfo.conditions.queryStartTime = "";
                vc.component.copyWorkInfo.conditions.queryEndTime = "";
                $that._listCopyWorks(DEFAULT_PAGE, DEFAULT_ROWS);
            },
