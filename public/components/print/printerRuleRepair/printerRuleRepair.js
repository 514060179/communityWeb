...
(function (vc) {
    ...
    vc.extends({
        ...
        methods: {
                ...
                vc.http.apiGet('/printer.listPrinterRuleRepair',
                    ...
                    function (json, res) {
                        ...
                        vc.emit('printerRuleRepairs', 'paginationPlus', 'init', {
                            ...
                            dataCount: vc.component.printerRuleRepairsInfo.total,
                            currentPage: _page
                        });
                    },
            ...
            //重置
            _resetPrinterRuleRepairsMethod: function () {
                vc.component.printerRuleRepairsInfo.conditions.prrId = "";
                vc.component.printerRuleRepairsInfo.conditions.repairTypeName = "";
                vc.component._listPrinterRuleRepairs(DEFAULT_PAGE, DEFAULT_ROWS);
            },
