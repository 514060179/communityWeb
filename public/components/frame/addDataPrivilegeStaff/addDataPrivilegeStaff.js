(function (vc) {
    ...
    vc.extends({
        ...
        methods: {
            _loadAllStaffInfo: function (_page, _row) {
                let param = {
                    params: {
                        page: _page,
                        row: _row,
                        staffId: $that.addDataPrivilegeStaffInfo.staffId,
                        staffName: $that.addDataPrivilegeStaffInfo.staffName,
            ...
            queryStaffs: function () {
                $that._loadAllStaffInfo(DEFAULT_PAGE, DEFAULT_ROWS);
            },
            //重置
            resetStaffs: function () {
                vc.component.addDataPrivilegeStaffInfo.staffId = "";
                vc.component.addDataPrivilegeStaffInfo.staffName = "";
                $that._loadAllStaffInfo(DEFAULT_PAGE, DEFAULT_ROWS);
            },
