    ...
    vc.extends({
        ...
        methods: {
            ...
            _jump2TransferGoodsPage: function () {
                vc.jumpToPage("/#/pages/common/transferGoodsManage");
            },
            //损耗
            ...
            //导出
            _exportMyResourceStore: function () {
                $that.myResourceStoreManageInfo.conditions.pagePath = 'myResourceStoreManage';
                let param = {
                    params: $that.myResourceStoreManageInfo.conditions
                };
                //发送get请求
