    ...
    vc.extends({
        ...
        methods: {
            ...
            _exportFee: function () {
                ...
                let _objType = vc.component.reportProficientInfo._currentTab == 'reportProficientRoomFee' ? "3333" : "6666"
                vc.component.reportProficientInfo.conditions.objType = _objType;
                vc.component.reportProficientInfo.conditions.communityId = vc.getCurrentCommunity().communityId;
                vc.component.reportProficientInfo.conditions.pagePath = 'reportProficient';
                let param = {
                    params: vc.component.reportProficientInfo.conditions
                };
                //发送get请求
