    ...
    vc.extends({
        ...
        _initEvent: function () {
            vc.on('chooseResourceStore', 'openChooseResourceStoreModel', function (_param) {
                ...
                $that.chooseResourceStoreInfo.newShId = _param.shId;
        ...
        methods: {
            ...
            resetResourceStores: function () {
                vc.component.chooseResourceStoreInfo.shId = vc.component.chooseResourceStoreInfo.newShId;
                vc.component.chooseResourceStoreInfo.parentRstId = "";
