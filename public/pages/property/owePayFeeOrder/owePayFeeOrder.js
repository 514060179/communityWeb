(function (vc) {
    ...
    vc.extends({
        ...
        methods: {
                    ...
                    function (json, res) {
                        ...
                        if (_data.code == 404) {
                            ...
                            if (_data.data && _data.data.orderId) {
                                ...
                                $that.owePayFeeOrderInfo.paymentPoolId = _data.data.paymentPoolId;
            ...
            _printOwnOrder2: function () {
                //打印催交单
                vc.emit('printOwnFee', 'openPrintOwnFeeModal',{
                    payObjId:$that.owePayFeeOrderInfo.payObjId,
                    payObjType:$that.owePayFeeOrderInfo.payObjType,
                    payObjName:$that.owePayFeeOrderInfo.roomName,
                })
            },
