...
(function (vc) {
    ...
    vc.extends({
        ...
        methods: {
            _listDataPrivilegeStaffs: function (_page, _rows) {
                let param = {
                    params: {
                        ...
                        tel: $that.dataPrivilegeStaffInfo.tel
                    }
                };
                //发送get请求
            ...
            //重置
            _resetDataPrivilegeStaffMethod: function () {
                vc.component.dataPrivilegeStaffInfo.staffName = "";
                vc.component.dataPrivilegeStaffInfo.tel = "";
                vc.component._listDataPrivilegeStaffs(DEFAULT_PAGE, DEFAULT_ROWS);
            },
