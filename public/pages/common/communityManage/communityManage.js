...
(function (vc) {
    ...
    vc.extends({
        ...
        methods: {
            _listCommunitys: function (_page, _rows) {
                ...
                vc.http.apiGet('/community.listCommunitys',
                    ...
                    function (json, res) {
                        ...
                        vc.component.communityManageInfo.total = _json.total;
                        vc.component.communityManageInfo.records = _json.records;
                        vc.component.communityManageInfo.communitys = _json.communitys;
                        $that.dealCommunityAttr(_json.communitys);
            ...
            _sendCommunityIot:function(_community){
                vc.emit('communityDataToIot', 'openCommunityDataToIotModal',{
