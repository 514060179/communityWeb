    ...
    vc.extends({
        ...
        methods: {
            ...
            _resetInspectionPlanMethod: function () {
                ...
                $that.purchaseApplyDetailManageInfo.conditions.name = "";
            ...
            _exportExcel: function () {
                /*vc.jumpToPage('/callComponent/exportReportFee/exportData?pagePath=purchaseApplyDetail&' +
                    vc.objToGetParam($that.purchaseApplyDetailManageInfo.conditions));*/
                vc.component.purchaseApplyDetailManageInfo.conditions.communityId = vc.getCurrentCommunity().communityId;
                vc.component.purchaseApplyDetailManageInfo.conditions.pagePath = 'purchaseApplyDetailManage';
                let param = {
