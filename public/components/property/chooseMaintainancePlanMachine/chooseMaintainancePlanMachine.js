(function (vc) {
    ...
    vc.extends({
        ...
        methods: {
            _loadAllMachinesInfo: function (_page, _row) {
                let param = {
                    params: {
                        page: _page,
                        row: _row,
                        machineName: vc.component.chooseMaintainancePlanMachineInfo.machineName,
            ...
            resetMachines: function () {
                vc.component.chooseMaintainancePlanMachineInfo.machineName = "";
                $that._loadAllMachinesInfo(1, 10);
            },
            ...
            isCheckAll: function (e) {
                let checkObj = document.querySelectorAll('.checkMachine');
                var count = 0;
                for (var i = 0; i < checkObj.length; i++) {
