    ...
    vc.extends({
        ...
        methods: {
            ...
            _resetInspectionPlanMethod: function () {
                ...
                $that.purchaseApplyManageInfo.conditions.name = "";
            ...
            _exportExcel: function () {
                ...
                vc.component.purchaseApplyManageInfo.conditions.communityId = vc.getCurrentCommunity().communityId;
                vc.component.purchaseApplyManageInfo.conditions.pagePath = 'purchaseApplyManage';
                let param = {
