...
(function (vc) {
    ...
    vc.extends({
        ...
        methods: {
                ...
                vc.http.apiGet('/printer.listPrinterRuleMachine',
                    ...
                    function (json, res) {
                        ...
                        vc.emit('printerRuleMachine', 'paginationPlus', 'init', {
                            ...
                            dataCount: vc.component.printerRuleMachineInfo.total,
                            currentPage: _page
                        });
                    },
            ...
            //重置
            _resetPrinterRuleMachineMethod: function () {
                vc.component.printerRuleMachineInfo.conditions.prmId = "";
                vc.component.printerRuleMachineInfo.conditions.machineName = "";
                vc.component._listPrinterRuleMachines(DEFAULT_PAGE, DEFAULT_ROWS);
            },
